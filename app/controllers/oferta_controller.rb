class OfertaController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to oferta_path, status: :see_other, notice: "Ofertum was successfully destroyed." }
  ...
  private
    ...
    def ofertum_params
      params.require(:ofertum).permit(:id_oferta, :id_producto, :fecha)
    end
end
